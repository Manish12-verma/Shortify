  ...
  return (
      ...
      onOpenChange={ (res)=> {if(!res) setSearchParams({})}}>
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <Input id="longUrl" placeholder="Enter Your Looooong Url" value={formValues.longUrl} onChange={handleChange}></Input>
          { errors.longUrl && <Error message={errors.longUrl} />}
          <div className="flex items-center gap-2">
            <Card className="p-2">shortify.in</Card> /
            <Input id="customUrl" placeholder="Custom Link (optional)" value={formValues.customUrl} onChange={handleChange}></Input>
          </div>
